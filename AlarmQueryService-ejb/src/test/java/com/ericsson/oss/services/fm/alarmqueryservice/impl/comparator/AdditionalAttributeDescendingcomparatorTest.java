...
public class AdditionalAttributeDescendingcomparatorTest {

    @InjectMocks
    private AdditionalAttributeDescendingcomparator additionalAttributeDescendingcomparator;
    ...
    public void testCompare() {
        additionalAttributeDescendingcomparator.setAttribute("attribute");
        ...
        assertEquals(0, additionalAttributeDescendingcomparator.compare(alarmRecord, sAlarmRecord));
        second.put("attribute", "xabcd");
        assertEquals(1, additionalAttributeDescendingcomparator.compare(alarmRecord, sAlarmRecord));
