...
public class BooleanTypeAscendingComparator implements Comparator<AlarmRecord> {

    String attribute;

    public BooleanTypeAscendingComparator(final String attribute) {
    ...
    public int compare(final AlarmRecord firstAlarmRecord, final AlarmRecord secondAlarmRecord) {
        ...
        if (firstValue != null && secondValue != null) {
            return ((Boolean) firstValue).compareTo((Boolean) secondValue);
        } else {
