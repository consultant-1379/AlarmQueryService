 ...
 * This class will take Attribute of type Integer. <br>
 *
 */

public class IntegerTypeDescendingComparator implements Comparator<AlarmRecord> {
    String attribute;

    public IntegerTypeDescendingComparator(final String attribute) {
    ...
    public int compare(final AlarmRecord firstAlarmRecord, final AlarmRecord secondAlarmRecord) {
        ...
        if (firstValue != null && secondValue != null) {
            return Integer.compare((Integer) secondValue, (Integer) firstValue);
        } else {
