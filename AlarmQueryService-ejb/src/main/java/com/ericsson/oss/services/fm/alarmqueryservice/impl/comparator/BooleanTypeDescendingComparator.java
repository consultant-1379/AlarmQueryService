 ...
 * This class will take Attribute of type Boolean. <br>
 */
public class BooleanTypeDescendingComparator implements Comparator<AlarmRecord> {
    String attribute;

    public BooleanTypeDescendingComparator(final String attribute) {
    ...
    public int compare(final AlarmRecord firstAlarmRecord, final AlarmRecord secondAlarmRecord) {
        ...
        if (firstValue != null && secondValue != null) {
            return ((Boolean) secondValue).compareTo((Boolean) firstValue);
        } else {
