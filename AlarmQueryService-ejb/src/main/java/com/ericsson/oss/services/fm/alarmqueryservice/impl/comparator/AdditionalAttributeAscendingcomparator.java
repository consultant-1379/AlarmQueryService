...
public class AdditionalAttributeAscendingcomparator implements Comparator<AlarmRecord> {
    private String attribute;

    public AdditionalAttributeAscendingcomparator(final String attribute) {
    ...
    public int compare(final AlarmRecord firstAlarmRecord, final AlarmRecord secondAlarmRecord) {
        ...
        return new ComparatorHelper().compareForAscending(firstValue, secondValue);
    }
